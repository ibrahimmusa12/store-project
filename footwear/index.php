...
$query = "SELECT * FROM storehomepage WHERE id ='4'";
...
.footer {
 ...
 <body>
  ...
  <a href="../index.php" >Home</a>
    <a href="../footwear/index.php" class="active">Footwear</a>
  	   ...
  	   <div align="center"><?php   foreach($title as $row)
                            {
								...
								$output .= '<h4 class=" box3">'  .$row["description"].' </div></div></h4>'; 
							 echo $output;
